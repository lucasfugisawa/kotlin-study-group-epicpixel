...
fun main() {
    ...
    fun imprimirSaudacao(
        nome: String,
        idade: Int? = null,
        saudacao: String = "Boas-vindas, ",

    ) {
        println("$saudacao, $nome! Você tem $idade anos.")
    }

    imprimirSaudacao(nome = "John", saudacao = "Olá, ")


    fun transformaNumeroEImprime(numero: Int, transf: (Int) -> (Int)) {
